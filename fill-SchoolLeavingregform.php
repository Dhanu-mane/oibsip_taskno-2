...
$ret="select DateofSchool Leaving from tblapplication where DateofSchool Leaving=:dob || NameofFather=:fname";
...
$sql="insert into tblapplication(UserID,ApplicationID,DateofSchoolLeaving,Gender,FullName,PlaceofSchoolLeaving,NameofFather,PermanentAdd,PostalAdd,MobileNumber,Email)values(:uid,:appnumber,:dob,:gender,:fname,:pob,:fathername,:padd,:postaladd,:mobnumber,:email)";
...
$query->bindParam(':email',$email,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("College Leaving detail has been added.")</script>';
echo "<script>window.location.href ='fill-SchoolLeavingregform.php'</script>";
  }
  else
    {
...
echo "<script>alert('Date of College Leaving and Father Name is  already exist. Please try again');</script>";
...
<head>
    ...
    <title>School Leaving Certificate Form | Online School Leaving Certificate System</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">School Leaving Registration Form</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Date of School Leaving</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Place of School Leaving</label>
                                                                </div>
                                                                <div class="col-lg-9">
