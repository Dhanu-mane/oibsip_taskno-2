...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2021 at 11:13 PM
...
CREATE TABLE `tblapplication` (
  ...
  `DateofSchoolLeaving` varchar(200) DEFAULT NULL,
  `Gender` varchar(50) DEFAULT NULL,
  `FullName` varchar(200) DEFAULT NULL,
  `PlaceofSchoolLeaving` varchar(200) DEFAULT NULL,
...
INSERT INTO `tblapplication` (`ID`, `UserID`, `ApplicationID`, `DateofSchoolLeaving`, `Gender`, `FullName`, `PlaceofSchoolLeaving`, `NameofFather`, `PermanentAdd`, `PostalAdd`, `MobileNumber`, `Email`, `Dateofapply`, `Remark`, `Status`, `UpdationDate`) VALUES
